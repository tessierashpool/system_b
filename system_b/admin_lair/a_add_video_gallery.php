...
if(isset($_REQUEST['a_save_vgallery_btn']))
{
	$code = safeStr($_REQUEST['code']);
	if($code!='')
	{
		if(!CVGallery::isValidCode($code)) 
		{
			CAdminPage::errorMsg(CMain::getM('ERROR_INVALID_CODE'));
		}		
		elseif(CVGallery::codeExist($code))
		{
...
?>
<?CAdminPage::setPageTitleIcon('video_gallery_add.gif');?>
