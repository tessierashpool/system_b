...
if(isset($_REQUEST['captcha_n'])&&$_REQUEST['captcha_n']!='')
{
	$captcha = new SimpleCaptcha($_REQUEST['captcha_n']);
}
else
{
...
class SimpleCaptcha {
    ...
    public function __construct($session_name = 'captcha') {
		$this->session_var = $session_name;
    }
    ...
    public function CreateImage() {
        ...
        $_SESSION[$this->session_var] = md5($text.$this->solt);
